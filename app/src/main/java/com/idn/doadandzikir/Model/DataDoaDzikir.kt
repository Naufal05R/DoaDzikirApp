...
object DataDoaDzikir {
    ...
    val listDataQauliyah: List<DoaDzikirItem>
        get() {
            val listData = mutableListOf<DoaDzikirItem>()
    ...
    val listDzikir: List<DoaDzikirItem>
        get() {
            val listData = mutableListOf<DoaDzikirItem>()
    ...
    val listDzikirPagi: List<DoaDzikirItem>
        get() {
            val listData = mutableListOf<DoaDzikirItem>()
    ...
    val listDzikirPetang: List<DoaDzikirItem>
        get() {
            val listData = mutableListOf<DoaDzikirItem>()
